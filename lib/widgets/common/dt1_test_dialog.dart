...
class _DT1TestDialogState extends State<DT1TestDialog> with TickerProviderStateMixin {
  ...
  Future<void> _startTest() async {
    ...
    try {
      ...
      if (dt1 != null) {
        ...
        setState(() {
          _testStatus = 'Test in progress... Please wait'.tr();
        });
          ...
          if (detailedStatus != null) {
            setState(() {
              if (detailedStatus['testInProgress'] == true) {
                _testStatus = 'Test in progress... (${i + 1}/${maxAttempts}s)'.tr();
                ...
                if (hasFailure) {
                  ...
                  _testStatus = 'Test completed successfully'.tr();
        ...
        if (_isTestRunning) {
          setState(() {
            ...
            _testCompleted = true;
            _isTestRunning = false;
            _testStatus = 'Test failed or timed out'.tr();
            _statusColor = Colors.red;
          });
        }
      } else {
      ...
      setState(() {
        ...
        _testCompleted = true;
        _isTestRunning = false;
        _testStatus = 'Test error: ${e.toString()}';
        _statusColor = Colors.red;
      });
    }
  ...
  void _stopTest() {
    setState(() {
      _isTestRunning = false;
      _testStatus = 'Test stopped by user'.tr();
      _statusColor = Colors.orange;
      _testCompleted = true;
      _testResult = null;
    });
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildInfoRow('Gateway Address'.tr(), widget.gatewayAddress),
